...
class ATM {
    ...
    public ATM() {
        user = new User[5];
        user[0] = new User("456271", "2002", 5632);
        user[1] = new User("207214", "1983", 1200);
        user[2] = new User("124645", "2164", 4500);
        user[3] = new User("789654", "4579", 3000);
        user[4] = new User("987456", "7845", 9000);
    }
